...
public final class ActivityAuthBinding implements ViewBinding {
  ...
  private ActivityAuthBinding(@NonNull FrameLayout rootView, @NonNull Button btnLogin,
      @NonNull EditText etPassword, @NonNull EditText etUsername, @NonNull ProgressBar progress,
  ...
  public static ActivityAuthBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityAuthBinding((FrameLayout) rootView, btnLogin, etPassword, etUsername,
          progress, tvRegister, tvTitle);
    }
