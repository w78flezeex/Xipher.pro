...
public final class ActivityLanguageBinding implements ViewBinding {
  ...
  private ActivityLanguageBinding(@NonNull LinearLayout rootView,
      ...
      @NonNull RadioGroup radioGroup, @NonNull RadioButton rbEn, @NonNull RadioButton rbRu) {
  ...
  public static ActivityLanguageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.rbRu;
      RadioButton rbRu = ViewBindings.findChildViewById(rootView, id);
      if (rbRu == null) {
        break missingId;
      }

      return new ActivityLanguageBinding((LinearLayout) rootView, bottomNav, btnBack, radioGroup,
          rbEn, rbRu);
    }
